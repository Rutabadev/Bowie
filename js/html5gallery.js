    ...
    b.fn.html5gallery = function (k) {
        ...
        e.prototype = {
            ...
            init: function (a) {
                ...
                a.options.watermarkcode += "<div " + (a.options.fv ? "" : "class='html5gallery-watermark-" + a.id + "' ") + "style='" + (a.options.fv ? "display:none;visibility:visible;position:absolute;top:10px;left:10px;width:170px;height:18px;line-height:18px;text-align:center;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;background-color:#fff;color:#333;font-size:12px;font-family:Arial,Helvetica,sans-serif;" :
                ...
                this.showimagetoolbox =
                    function (a, c) {
                        if (this.options.showplaybutton || this.options.showprevbutton || this.options.shownextbutton || this.options.showfullscreenbutton) {
                            ...
                            } else this.options.showplaybutton &&
            ...
            showImage: function () {
                ...
                b(d).on("load", function () {
                    ...
                    if (c.isFullscreen) {
                        ...
                        d = 1 < d ? 1 : d
                    } else d = "fill" == c.options.resizemode ? Math.max(c.options.width / this.width,
...
function HTML5GalleryTimer(u, v, n) {
    ...
    this.resume = function (u) {
        if (!b || u) b = !1, m && z && (z = !1, x = setInterval(function () {
            k += 50;
...
function HTML5GallerySWFObjectFunc() {
    function u() {
        if (!A) {
            ...
            A = !0;
            for (var a = Q.length, c = 0; c < a; c++) Q[c]()
        }
    }
        ...
        if (0 < b)
            for (var c = 0; c < b; c++) {
                ...
                if (0 < r.pv[0]) {
                    var l = e(g);
                    if (l)
                        if (a(H[c].swfVersion) && !(r.wk && 312 > r.wk)) d(g, !0), h && (j.success = !0, j.ref = x(g), h(j));
    ...
    function c(a, b, c, d) {
        if (!r.ie || !r.mac) {
            ...
            if (e) {
                ...
                d && (O = B = null);
                if (!B ||
                    O != c) d = q.createElement("style"), d.setAttribute("type", "text/css"), d.setAttribute("media", c), B = e.appendChild(d), r.ie && (r.win && typeof q.styleSheets != f && 0 < q.styleSheets.length) && (B = q.styleSheets[q.styleSheets.length - 1]), O = c;
    ...
    if (typeof G.plugins != f && typeof G.plugins["Shockwave Flash"] ==
        h) {
        if ((y = G.plugins["Shockwave Flash"].description) && !(typeof G.mimeTypes != f && G.mimeTypes[l] && !G.mimeTypes[l].enabledPlugin)) V = !0, K = !1, y = y.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), F[0] = parseInt(y.replace(/^(.*)\..*$/, "$1"), 10), F[1] = parseInt(y.replace(/^.*\.(.*)\s.*$/, "$1"), 10), F[2] = /[a-zA-Z]/.test(y) ? parseInt(y.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    } else if (typeof t.ActiveXObject != f) try {
        var L = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
        if (L && (y = L.GetVariable("$version"))) K = !0, y = y.split(" ")[1].split(","),
